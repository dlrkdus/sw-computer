...
function scene:create( event )
	...
	local S1=display.newRect(display.contentWidth*0.21, display.contentHeight*0.745,30,30)
	S1:setFillColor(0)
	...
	correct.x,correct.y = display.contentWidth*0.21,display.contentHeight*0.747
	correct.alpha=0
	...
	local somText = display.newText("아끼는 연필을 잃어버렸어..",display.contentWidth*0.855, display.contentHeight*0.47,"font/NanumSquare_acB.ttf")
