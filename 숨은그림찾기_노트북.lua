...
function scene:create( event )
	...
	local S1=display.newRect(display.contentWidth*0.198, display.contentHeight*0.5,30,30)
	S1:setFillColor(1)
	...
	correct.x,correct.y = display.contentWidth*0.198,display.contentHeight*0.502
	correct.alpha=0
	...
	local somText = display.newText("내 노트북이 어디갔지?",display.contentWidth*0.855, display.contentHeight*0.48,"font/NanumSquare_acB.ttf")
